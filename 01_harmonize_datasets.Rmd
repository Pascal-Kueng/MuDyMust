...
df_kamp <- df_kamp[df_kamp$day_ent >= 0,] # !todo: will we only include these days? I don't think we will be able to use KAMP altogether actually?
...
global_required_predictors <- c("emo_support", "pract_support", "pos_control", "neg_control") # !todo: which variables?
